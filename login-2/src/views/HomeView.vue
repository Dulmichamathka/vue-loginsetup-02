                  ...
                  <v-card-text class="mt-12">
                    ...
                    <v-row align="center" justify="center">
                      <v-col cols="12" sm="8">
                        ...
                        <v-btn color="blue" dark block title> Login in</v-btn>
              ...
              <v-row>
                <v-col cols="12" sm="6" class="blue rounded-br-xl">
                  <div style="text-align: center; padding: 180px 0px">
                    <v-card-text class="white--text">
                      ...
                      <h6 class="text-center">
                        SignLog in to your account so you can continue building
                        and<br />editing your onboarding flows
                      </h6>
                    </v-card-text>
                    <div class="text-center">
                ...
                <v-col cols="12" sm="6">
                  <v-card-text class="mt-12">
                    ...
                    <h6 class="text-center grey--text">
                      Let's get you all set up so you can start creation your<br />
